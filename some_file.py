...
video_id = input("Enter video ID for YouTube video: ")
# sample video = 'WEmcW59Hz6M'
comments = comment_threads(video_id)


def comments_sql(comments):
    ...
    dataframe.to_sql('topCommentsTable', con=engine, if_exists='replace',
                     index=False)
